              ...
              <>
               ...
               <Link 
                ...
                >
                 ...
                 <Link 
                to={`/my-teams/${localStorage.getItem("lastMatchId") || "default"}`} 
                className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700 hover:text-yellow-300 transition-all duration-200 flex items-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m2 0a2 2 0 100-4H7a2 2 0 100 4zm2 0a2 2 0 11-4 0m0 4h.01" />
                </svg>
                My Teams
              </Link>
