        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center space-x-2 mb-3">
              ...
              />
              <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-yellow-300">
                CRICXI
              </span>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-semibold text-yellow-400 uppercase mb-2">Quick Links</h3>
            <ul className="space-y-1">
              <li>
                <Link to="/" className="text-xs text-gray-300 hover:text-yellow-400 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/matches" className="text-xs text-gray-300 hover:text-yellow-400 transition-colors">
                  Matches
                </Link>
              </li>
              <li>
                <Link to="/leaderboard" className="text-xs text-gray-300 hover:text-yellow-400 transition-colors">
                  Leaderboard
                </Link>
              </li>
            </ul>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-xs font-semibold text-yellow-400 uppercase mb-2">Legal</h3>
            <ul className="space-y-1">
              <li>
                <Link to="/privacy-policy" className="text-xs text-gray-300 hover:text-yellow-400 transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms-and-conditions" className="text-xs text-gray-300 hover:text-yellow-400 transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xs font-semibold text-yellow-400 uppercase mb-2">Contact</h3>
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-xs text-gray-300">contact@cricxi.com</span>
              </li>
              <li className="flex items-center">
                <svg className="h-4 w-4 text-gray-400 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-xs text-gray-300">+1 (234) 567-8900</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="mt-6 pt-4 border-t border-gray-700/50 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-400">
            © {new Date().getFullYear()} CRICXI Fantasy League
          </p>
          <div className="mt-2 md:mt-0">
            <p className="text-xs text-gray-300">
              Built with ❤️ by <span className="text-yellow-400">Team CRICXI</span>
            </p>
          </div>
        </div>
      </div>
